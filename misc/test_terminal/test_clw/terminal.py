...
class Terminal(object):
    ...
    query_args_mg = "[%s,%s,1,1.0.0,B123,T5,%s]"
    set_args_mg = "[%s,%s,1,1.0.0,B123,T6,%s]"
    reboot_mg = "[%s,%s,1,1.0.0,B123,T7,1]"
    remote_set_mg = "[%s,%s,1,1.0.0,B123,T8,1]"
    remote_unset_mg = "[%s,%s,1,1.0.0,B123,T9,0]"
    ...
    config_mg = "[%s,%s,1,1.0.0,B123,T17]"
    defend_report_mg = "[%s,%s,1,1.0.0,B123,T18,1]"
    ...
    ARGS = DotDict(PSW="123456",
                   ...
                   VIN='11145600',
                   PLCID='123',
                   IMSI='960023615223538',
                   IMEI='955889008722099'
                   )
    ...
    def login_response(self, bp):
        ...
        t_time = int(time.time())
        mg = self.config_mg% (t_time, self.sessionID)
        self.socket.send(mg)
    ...
    def report_once_mg(self):
        ...
        pvt_mg = self.pvt_mg % (t_time, self.sessionID)
        locationdesc_mg = self.locationdesc_mg % (t_time, self.sessionID)
