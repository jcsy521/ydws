...
class ErrorCode(object):
    ...
    ERROR_MESSAGE  = {
        ...
        ILLEGAL_ALIAS:                 u"定位仪别名中含有非法字符，请重新输入。",
        ...
        USER_NOT_ORDERED:              u"对不起, 该号码尚未订购定位仪Beta版本业务。",
        SERVER_ERROR:                  u"服务器错误。",
        SERVER_BUSY:                   u"服务器忙，请稍后重试。",
        QUERY_TRACK_FORBID:            u"您使用的是简易版定位仪Beta版本，不支持轨迹查询功能。",
        QUERY_INTERVAL_EXCESS:         u"对不起，只能查询一个星期之内的记录！",
        REGION_ADDITION_EXCESS:        u"对不起，电子围栏数已超过上限。",
        REGION_NOT_EXISTED:            u"对不起，该围栏已经不存在。",
        TERMINAL_NOT_ORDERED:          u"对不起，该号码尚未绑定定位仪。",
        MOBILE_NOT_ORDERED:            u"%s不是定位仪Beta版本白名单号码，请联系客服。",
        TERMINAL_NOT_EXISTED:          u"对不起，该终端不存在。",
        LOCATION_NAME_NONE:            u"无法解析经纬度对应的地址",
        LOCATION_FAILED:               u"定位不成功",
        LOCATION_CELLID_FAILED:        u"定位仪基站定位失败，请稍后重试。",
        LOCATION_OFFSET_FAILED :       u"经纬度偏转失败，请稍后重试。",
        TRACKER_POWER_FULL:            u"定位仪电池充满，剩余电量100%",
        TRACKER_POWER_LOW:             u"定位仪电量低，剩余电量%s%%",
        TRACKER_POWER_OFF:             u"定位仪电量低于5%，即将关机",
        FOB_POWER_LOW:                 u"定位仪挂件“%s”电量低",
        TERMINAL_OFFLINE:              u"定位仪不在线，请确认定位仪处于开机状态。",
        TERMINAL_TIME_OUT:             u"定位仪响应超时，请稍后重试。",
        TERMINAL_OTHER_ERRORS:         u"连接定位仪失败，请稍后重试。",
        TERMINAL_ORDERED:              u"定位仪手机号已被注册，请检查确认后重试！",
        EC_MOBILE_EXISTED:             u"集团手机号已被注册，请检查确认后重试！",
        EC_NAME_EXISTED:               u"该集团已被注册，请检查确认后重试！",
        CNUM_EXISTED:                  u"该车牌号已被使用！",
        TERMINAL_SET_FAILED:           u"定位仪参数设置失败，请稍后重试。",
