...
class SMSCode(object):
    ...
    SMS_SOS = u"您的爱车保%s发起的应急救援请求，爱车保平台已收到，地址：%s，时间：%s。"
    SMS_SOS_OWNER = u"您的爱车保%s发起应急救援请求，已通知%s，当前所在位置：%s，时间：%s。"
    SMS_SOS_WHITE = u"爱车保%s发起应急救援请求，当前所在位置：%s，时间：%s。"
    ...
    SMS_RETRIEVE_PASSWORD = u"尊敬的车主, 您刚才使用了爱车保网站的密码找回功能，新的登陆密码为：%s，请妥善保管。如需修改密码，请登录爱车保网站进行修改。" 
