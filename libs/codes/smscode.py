...
class SMSCode(object):
    ...
    SMS_REG = u"尊敬的客户：您的【移动卫士】验证码为：%s，请5分钟内进行激活。若非您本人或授权操作，请联系【移动卫士】客服，客服热线：400-863-0388。" 
    ...
    SMS_DOWNLOAD_REMIND = u"尊敬的客户：请点击 %s/download?category=2 下载安装【移动卫士】客户端。"
    SMS_REGISTER_YDWQ = u"尊敬的客户：您将加入贵企业/单位移动卫士位置管理群组中，请点击 %s/clientdownload?category=2 下载客户端，安装打开客户端后，同意加入请输入激活码%s，成功加入群组后，您的位置将在贵企业/单位指定时间内上报到后台。 " 
    ...
    SMS_NOTIFY_DAY = u"尊敬的客户，您的车辆“%s”已达到保养时间，请及时进行保养。若已保养，请登录网页或手机客户端重新设置“下次保养时间”【移动卫士】"
    SMS_NOTIFY_ASSIST_DAY = u"定位器:%s，车主号码：%s，车主姓名：%s。该车辆已达到保养时间，该进行车辆保养。"
