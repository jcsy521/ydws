...
class SMSCode(object):
    ...
    # TO user
    SMS_TRACKER_POWERLOW = u"您的爱车保%s电量不足，当前电量为%d%%；时间：%s"
    SMS_FOB_POWERLOW = u"您的爱车保挂件%s电量不足，当前电量为%d%%；时间：%s"
    ...
    SMS_TERMINAL_HK_RJH = u"您的爱车保%s已经换卡，请发送换卡短信指令：‘HK+新爱车保号码+平台登录密码’到新爱车保号码。例如：HK 13900000000 111111"
