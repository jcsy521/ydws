...
class SMSCode(object):
    ...
    SMS_POWERDOWN = u"尊敬的客户：检测到您的定位器“%s”已经断开充电。地址：%s，时间：%s。"
    SMS_POWERDOWN_NOLOC = u"尊敬的客户：检测到您的定位器“%s”已经断开充电。地址：因定位信号弱，当前暂时无法定位，请关注车辆状态，时间：%s。"
    ...
    SMS_SOS_NOLOC = u"您的定位器“%s”发起的应急救援请求，【移动车卫士】平台已收到，地址：因定位信号弱，当前暂时无法定位，请关注车辆状态，时间：%s。"
    ...
    SMS_MOBILE_NOT_WHITELIST = u"尊敬的客户：您的定位器号码%s不是指定移动车卫士号码，请联系【移动车卫士】客服。"
