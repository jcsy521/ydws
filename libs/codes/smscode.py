...
class SMSCode(object):
    ...
    SMS_HEARTBEAT_LOST_YDWQ = u"尊敬的客户：您的安捷通(位置上报)“%s”与平台通讯可能出现异常，请检查是否处于正常状态，时间：%s。"
    SMS_SOS = u"您的定位器“%s”发起的应急救援请求，【安捷通】平台已收到，地址：%s，时间：%s。"
    SMS_SOS_NOLOC = u"您的定位器“%s”发起的应急救援请求，【安捷通】平台已收到，地址：因定位信号弱，当前暂时无法定位，请关注定位器状态，时间：%s。"
    ...
    SMS_LOGIN_REMIND = u"尊敬的客户：您于%s通过%s登录【安捷通】平台，用户号码为%s，所关联的定位器为“%s”。"
    SMS_CHARGE = u"尊敬的客户：您的定位器“%s”当前帐户信息：%s"
    SMS_CHARGE_REMIND = u"尊敬的客户：为了不影响安捷通业务的正常使用，请您及时为您的安捷通账号：%s进行充值，如已经缴费或者已经合并账号缴费请不用理会此短信。【安捷通】"
    SMS_SERVICE_STOP = u"尊敬的客户：您的定位器“%s”已经停止服务。"
    SMS_RETRIEVE_PASSWORD = u"尊敬的客户：您刚才使用了【安捷通】密码找回功能，新的登录密码为：%s，请妥善保管。如需修改密码，请登录【安捷通】网站或手机客户端进行修改。" 
    SMS_RESET_PASSWORD = u"尊敬的客户：您的密码刚才被【安捷通】客服人员进行了重置，新的登录密码为：%s，请妥善保管。如需修改密码，请登录【安捷通】网站或手机客户端进行修改。" 
    SMS_CAPTCHA = u"尊敬的客户：您【安捷通】找回密码所需的验证码为：%s，请5分钟内进行修改。若非您本人或授权操作，请联系【安捷通】客服。" 
    SMS_REG = u"尊敬的客户：您的【安捷通】验证码为：%s，请5分钟内进行激活。若非您本人或授权操作，请联系【安捷通】客服。" 
    ...
    SMS_JH_FAILED = u"激活失败，请确认手机号是否正确，或联系【安捷通】客服。"
    ...
    SMS_TID_EXIST = u"尊敬的客户：该定位器序列号%s冲突，请联系【安捷通】客服。"
    ...
    SMS_MOBILE_NOT_WHITELIST = u"尊敬的客户：您的定位器号码%s不是指定安捷通号码，请联系【安捷通】客服。"
    SMS_DELETE_TERMINAL = u"尊敬的客户：您的定位器号码%s已经解绑。如非本人操作，请联系【安捷通】客服。"
    SMS_UNUSUAL_ACTIVATE = u"尊敬的客户：该定位器%s已经被使用，原用户解绑后方可使用。"


    #SMS_DOWNLOAD_REMIND = u"尊敬的客户：请手机登录中山无线城市手机网站 gd.wxcs.cn/zs 进入‘下载’-‘安捷通’ 下载安装【安捷通】客户端。"
    SMS_DOWNLOAD_REMIND = u"尊敬的客户：请点击 http://www.ydcws.com/download?category=2 下载安装【安捷通】客户端。"
    SMS_DOWNLOAD_REMIND = u"尊敬的客户：请点击 http://www.ydcws.com/download?category=2 下载安装【安捷通】客户端。"
    #SMS_REGISTER_YDWQ = u"尊敬的客户：您将加入贵企业/单位安捷通位置管理群组中，请点击 http://www.ydcws.com/download?category=4 下载客户端，安装打开客户端后，同意加入请输入验证码 %s，成功加入群组后，您的位置将在贵企业/单位指定时间内上报到后台。 " 
    SMS_REGISTER_YDWQ = u"尊敬的客户：您将加入贵企业/单位安捷通位置管理群组中，请点击 http://www.ichebao.net/clientdownload?category=2 下载客户端，安装打开客户端后，同意加入请输入激活码%s，成功加入群组后，您的位置将在贵企业/单位指定时间内上报到后台。 " 

    SMS_NEW_OPERATOR = u"尊敬的客户：您已经成为安捷通集团用户管理员，平台网址：%s，用户名：%s，密码：%s"
