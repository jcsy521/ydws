...
class SMSCode(object):
    ...
    SMS_TRACKER_POWERLOW_NOLOC = u"尊敬的客户：您的定位器“%s”电量不足，当前电量为%d%%，时间：%s。"
