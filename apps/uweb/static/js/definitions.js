...
var LASTPOSITION_URL = '/lastposition'; //动态更新当前终端数据
...
var CHECKPASSENGERMOBILE_URL = '/checkpassengermobile';//乘客手机号验证
...
var PASSENGER_URL = '/passenger';	// 乘客管理
var PUSHINFO_URL = '/pushinfo'; //消息推送
var ROUTELINE_URL = '/line'; //线路管理
