...
$(function() {
	...
	*/
	...
	$('#t_corp_owner_mobile').formValidator({empty:true, validatorGroup: '7'}).inputValidator({max: 11, onError: '短信接收号码最大长度是11位！'}).regexValidator({regExp: 'owner_mobile', dataType: 'enum', onError: '短信接收号码不合法，请重新输入！'});
