...
$(function() {
	...
	*/
	...
	$('#t_corp_umobile').formValidator({empty:true, validatorGroup: '7'}).inputValidator({max: 11, onError: '车主手机号最大长度是11位！'}).regexValidator({regExp: 'owner_mobile', dataType: 'enum', onError: '车主号码不合法，请重新输入！'});
